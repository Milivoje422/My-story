...
<body>
    <?php 
        include 'functions/dashboard_fun.php'; 
 ...
 <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top top-navbar custom-nav-bar" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand custom-nav-bar" href="dashboard.php">My Story</a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                        <div class="user-img-div backg-color">
                            
                            <?php if(empty($user_info['user_image']) OR $user_info['user_image'] == "" && $user_info['user_image'] == NULL):  ?>
                        <?php echo '<a href="profil.php?user_id='.$user_info['user_id'].'">';?><img src="assets/img/avatar.jpeg" class="img-thumbnail"/></a>
                            <?php else:
                                echo '<a href="profil.php?user_id='.$user_info['user_id'].'">';?><img src="<?php echo $user_info['user_image'];?>" class="img-thumbnail"/></a>  
                        <?php  endif; ?>
